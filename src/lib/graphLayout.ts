    ...
    for (const block of blocks) {
      ...
      flowNodes.push({
        ...
        data: {
          ...
          nodeRelevance: block.nodeRelevance,
          connectionInsights: block.connectionInsights,
          entryBarriers: block.entryBarriers,
          typicalClients: block.typicalClients,
          expenseRange: block.expenseRange,
          incomeRange: block.incomeRange,
          demandTrend: block.demandTrend,
          competitiveSaturation: block.competitiveSaturation,
          unmetNeeds: block.unmetNeeds,
          marginProfile: block.marginProfile,
          disruptionRisk: block.disruptionRisk,
          clientSwitchingCosts: block.clientSwitchingCosts,
          valueChainPosition: block.valueChainPosition,
